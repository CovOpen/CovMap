      ...
      <main className="sections">
        ...
        <section>
          ...
          <Typography variant="body1">
            <p>
              ...
              personenbezogener Daten auf dieser Website verantwortlich ist. Die Kontaktdaten lauten wie folgt:
            </p>
            ...
            <br />
            <p>
              Für die Datenverarbeitung auf Ihrem Endgerät, auf das Sie die CovMap laden, sind Sie selbst
              verantwortlich. Das gilt auch für die Eingabe der Postleitzahl (siehe unter 5 c)).
            </p>
            <p>
              Grundlage der für den Nutzer der Website visualisierten Darstellung sind Daten, die von der Firma NET
              CHECK GmbH zusammengestellt und verarbeitet werden. Die Charité übernimmt mit diesem Webangebot die reine
              Visualisierung in Form einer Deutschlandkarte der insoweit von der NET CHECK GmbH zur Verfügung gestellten
              Information. Die Charité haftet nur für eigene Inhalte; als Diensteanbieter ist die Charité nicht
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            die sich auf die Charité beziehen, wenden Sie sich bitte an unsere Datenschutzbeauftragte:
            <br />
            <br />
            t: +49 30 450 580 016
            <br />
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            App-Store-Software voraus. Wir haben keinen Einfluss auf die Verarbeitung von personenbezogenen Daten im
            Zusammenhang mit Ihrer Registrierung und der Bereitstellung von Downloads in dem jeweiligen App-Store und
            der App-Store-Software. Verantwortliche Stelle ist insoweit allein der Betreiber des jeweiligen App-Stores.
          </Typography>
        </section>
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            für die Dauer der Sitzung gespeichert bleiben. Ihre IP-Adresse löschen wir nach Ablauf von 20 Tagen. Wir
            speichern sie 20 Tage lang, damit wir im Fall von Datensicherheitsmängeln oder Problemen von Eingriffen der
            Nutzenden Rechtsverstöße verfolgen können. Nach Ende der Aufbewahrung werden die IP-Adressen unverzüglich
            gelöscht. Im Übrigen werden die Daten in unserem System gelöscht, wenn die jeweilige Sitzung beendet ist.
            <br />
            Die Erfassung der Daten zur Bereitstellung CovMap ist für den Betrieb der Applikation zwingend erforderlich.
            Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. f DS-GVO.
            <br />
            <br />
            b. Session-Cookies
            <br />
            Beim Aufruf der CovMap erheben wir während einer laufenden Verbindung über Ihren Internet-browser und mit
            ...
            <br />
            Die Verarbeitung erfolgt ebenfalls auf der Rechtsgrundlage des Art. 6 Abs. 1 lit. f DS-GVO. Unser
            berechtigtes Interesse bei der Verwendung von technischen Cookies liegt in der Ermöglichung der Nutzung und
            ...
            einstellen. <br />
            Dies ist eine freiwillige Option und keine Voraussetzung zur Nutzung der CovMap. Die Eingabe der
            Postleitzahl findet ausschließlich auf Ihrem lokalen Endgerät statt. Es erfolgt keine Verknüpfung mit
            personenbezogenen Daten durch uns. Bei der Postleitzahl handelt es sich insoweit nicht um ein
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            <br />
            Mit oder ohne Eingabe Ihrer Postleitzahl zeigt Ihnen die CovMap im Anschluss an den Aufruf der Seite bzw.
            App eine Karte an, auf der tagesaktuell visualisiert wird, in welchen Gebieten ein lokaler Ausbruch von
            Covid-19 zu erwarten ist. Zur Darstellung der Karte setzen wir ebenfalls den Dienst von KeyCDN ein. Die
            IP-Adresse wird nicht gespeichert. <br />
            Ansonsten werden im Rahmen der Nutzung der CovMap keine personenbezogenen Daten von Ihnen an Dritte
            übermittelt, es sei denn, wir sind von Gesetzes wegen dazu verpflichtet oder Sie haben Ihre Einwilligung
            erklärt.
            <br />
          </Typography>
        </section>
