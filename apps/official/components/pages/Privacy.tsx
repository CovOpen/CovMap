...
Die CovMap ist ein Projekt der Charité – Universitätsmedizin Berlin, die für die Verarbeitung personenbezogener Daten verantwortlich ist:
...
E-Mail: datenschutz(at)charite.de
        ...
        <section>
          ...
          <Typography variant="body1">
          Personenbezogene Daten sind alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person beziehen. Als identifizierbar wird eine natürliche Person angesehen, die direkt oder indirekt identifiziert werden kann - insbesondere mittels Zuordnung zu einer Kennung wie einem Namen, zu einer Kennnummer, zu Standortdaten oder zu einer Online-Kennung (IP-Adresse). 
          </Typography>
        </section>
...
•	die vollständige IP-Adresse des anfordernden Endgeräts 
...
Die Verarbeitung erfolgt auf der Rechtsgrundlage des Art. 6 Abs. 1 lit. f DSGVO. Unser berechtigtes Interesse bei der Verwendung von technischen Cookies liegt in der Ermöglichung der Nutzung und Bereitstellung der CovMap. Bei den Cookies handelt es sich um für die Nutzung von CovMap technisch zwingend notwendige Cookies. 
...
Wir speichern die von Ihnen abgegebene Einwilligungserklärung. Dies dient dazu unsererseits den Nachweis führen zu können, dass Sie in die Datenverarbeitung durch uns eingewilligt haben. Diese Einwilligungserklärungen werden von uns zur ggf. notwendigen Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen für vier Jahre gespeichert, dies ergibt sich aus Art. 17 Abs. 3 lit. e DS-GVO.
...
Die Verarbeitung der IP-Adresse der Nutzerinnen und Nutzer der CovMap erfolgt mit den entsprechend vereinbarten Sicherheitsanforderungen im Rahmen einer Auftragsverarbeitung nach Art. 28 Abs. 3 DS-GVO durch den Technologiedienstleister proinity LLC, Rümikerstrasse 60, 8409 Winterthur, Schweiz ("KeyCDN"). Verantwortlich für die Datenverarbeitung bleiben wir.
Mit oder ohne Eingabe Ihrer Postleitzahl zeigt Ihnen die CovMap im Anschluss an den Aufruf der Seite bzw. App eine Karte an, auf der tagesaktuell visualisiert wird, in welchen Gebieten ein lokaler Ausbruch von Covid-19 zu erwarten ist. Zur Darstellung der Karte setzen wir ebenfalls den Dienst von KeyCDN ein. Die IP-Adresse wird nicht gespeichert. 
Ansonsten werden im Rahmen der Nutzung der CovMap keine personenbezogenen Daten von Ihnen an Dritte übermittelt, es sei denn, wir sind von Gesetzes wegen dazu verpflichtet oder Sie haben Ihre Einwilligung erklärt.
        ...
        <section>
          <Typography variant="h2">7.	Keine Pflicht zur Bereitstellung; keine automatisierte Entscheidungsfindung  einschl. Profiling</Typography>
          <Typography variant="body1">

Eine Pflicht zur Bereitstellung der personenbezogenen Daten besteht nicht. Eine automatisierte Entscheidungsfindung findet nicht statt. 
          </Typography>
        </section>
