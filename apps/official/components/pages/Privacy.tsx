      ...
      <main className="sections">
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            personenbezogener Daten verantwortlich ist: Charité – Universitätsmedizin Berlin Charitéplatz 1 10117 Berlin
            Deutschland Tel: +49 (0) 30 450 50 Website: www.charite.de
          </Typography>
        </section>
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            wenden Sie sich bitte an unsere Datenschutzbeauftragte: t: +49 30 450 580 016 E-Mail:
        ...
        <section>
          ...
          <Typography variant="body1">
            a. Log-Dateien (sog. Log Files) Bei jedem Zugriff auf die CovMap werden Daten über diesen Vorgang
            vorübergehend in einer Protokolldatei verarbeitet. Im Einzelnen werden folgende Daten gespeichert: • das
            Datum und die Uhrzeit des Aufrufs der CovMap • verwendete Webbrowser und verwendetes Betriebssystem • die
            vollständige IP-Adresse des anfordernden Endgeräts • der Name und die URL der abgerufenen Datei • im Fall
            des Aufrufs der Web-App auch die Webseite, von der aus der Zugriff erfolgt • der Name des verwendeten
            Internet-Providers Diese Datenverarbeitung durch unser System dient dem Zweck und unserem Interesse, die
            Auslieferung der CovMap an das Endgerät des Nutzers/der Nutzerin zu ermöglichen. Hierfür muss die IP-Adresse
            der Nutzenden für die Dauer der Sitzung gespeichert bleiben. Ihre IP-Adresse löschen wir nach Ablauf von
            vier Wochen. Wir speichern sie vier Wochen, damit wir im Fall von Datensicherheitsmängeln oder Problemen von
            Eingriffen der Nutzenden Rechtsverstöße verfolgen können. Nach Ende der vierwöchigen Aufbewahrung werden die
            IP-Adressen unverzüglich gelöscht. Im Übrigen werden die Daten in unserem System gelöscht, wenn die
            jeweilige Sitzung beendet ist. Die Erfassung der Daten zur Bereitstellung CovMap ist für den Betrieb der
            Applikation zwingend erforderlich. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. f DS-GVO. b.
            Session-Cookies Beim Aufruf der CovMap erheben wir während einer laufenden Verbindung über Ihren
            Internetbrowser und mit Hilfe von technisch notwendigen sog. Session-Cookies Daten. Diese Daten beziehen
            sich lediglich auf Ihre IP-Adresse (siehe nachstehende Bullet Points). Session-Cookies ermöglichen die
            Funktionalität dieser Anwendungen. Sie verfallen nach 24 Stunden. Die meisten Browser sind so eingestellt,
            dass sie Cookies automatisch akzeptieren. Sie können das Speichern von Cookies jedoch deaktivieren oder
            Ihren Browser so einstellen, dass er Sie benachrichtigt, sobald Cookies gesendet werden. Durch den Einsatz
            von Cookies fließen der Stelle, die den Cookie setzt (hier der durch uns eingesetzte Auftragsverarbeiter
            KeyCDN, siehe dazu unter 6.) folgende Informationen zu: • Datum und Uhrzeit des Aufrufs der Website •
            verwendete Webbrowser und verwendetes Betriebssystem • vollständige IP-Adresse des anfordernden Endgeräts •
            übertragene Datenmenge • Name des verwendeten Internet-Providers. Die Verarbeitung erfolgt auf der
            Rechtsgrundlage des Art. 6 Abs. 1 lit. f DSGVO. Unser berechtigtes Interesse bei der Verwendung von
            technischen Cookies liegt in der Ermöglichung der Nutzung und Bereitstellung der CovMap. Bei den Cookies
            handelt es sich um für die Nutzung von CovMap technisch zwingend notwendige Cookies. c. Eingabe der
            Postleitzahl Bei Aufruf der App besteht die Möglichkeit, dass Sie die Postleitzahl Ihrer Heimatadresse
            eingeben. Dies ist eine freiwillige Option und keine Voraussetzung zur Nutzung der CovMap. Sofern Sie Ihre
            Postleitzahl eingeben, wird diese mit Ihrer IP-Adresse verknüpft und durch uns dazu verwendet, Ihnen bei der
        ...
        <section>
          ...
          <Typography variant="body1">
            Sie haben grundsätzlich folgende Rechte hinsichtlich der Sie betreffenden personenbezogenen Daten: - Recht
            auf Auskunft (Art. 15 DS-GVO) - Recht auf Berichtigung (Art. 16 DS-GVO) - Recht auf Löschung (Art. 17
            DS-GVO; “Recht auf Vergessenwerden”) - Recht auf Einschränkung der Verarbeitung (Art. 18 DS-GVO) - Recht auf
            Widerspruch gegen die Verarbeitung (Art. 21 DS-GVO) - Recht auf Datenübertragbarkeit (Art. 20 DS-GVO) Soweit
            Sie uns eine Einwilligung in die Verarbeitung Ihrer Daten erteilt haben, können Sie diese jederzeit mit
            Wirkung für die Zukunft widerrufen. Die Rechtmäßigkeit der Verarbeitung Ihrer Daten bis zum Widerruf bleibt
            hiervon unberührt. Sie haben zudem das Recht, sich bei einer Datenschutz-Aufsichtsbehörde in dem
