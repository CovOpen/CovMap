    ...
    <main className="sections">
      ...
      <section>
        ...
        <Typography>
          ...
          ist eine wichtige Maßzahl, mit der wir beurteilen können, ob wir es dem Virus schwer genug gemacht haben. Der
          R-Wert besagt, wie viele Personen von einer infizierten Person im Durchschnitt angesteckt werden. Wenn der
          ...
          sinkt. Das Problem des R-Werts ist es, dass er das Infektionsgeschehen mit mehreren Tage Verzögerung abbildet,
          da er aus der Zahl der bestätigten Infektionen berechnet wird. Dies erscheint auch logisch, wenn man bedenkt,
          dass man nach einer Ansteckung mit dem Coronavirus nicht sofort Symptome entwickelt und auch das Ergebnis
          eines Labortests mit mehreren Tagen Verzögerung dem Robert-Koch-Institut mitgeteilt wird. Der R-Wert ist somit
          immer ein Blick in die Vergangenheit. Unsere Gruppe hat ein{" "}
          ...
          vom Kontakt-Index ist nun, dass er fast ohne Verzögerung berechnet werden kann. Von einem erhöhten
