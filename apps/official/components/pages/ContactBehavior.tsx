    ...
    <main className="sections">
      ...
      <section>
        ...
        <Typography>Der
          ...
          sinkt.</Typography><Typography>
          Das Problem des R-Werts ist es, dass er das Infektionsgeschehen mit mehreren Tage Verzögerung abbildet,
          ...
          immer ein Blick in die Vergangenheit.</Typography>
        <Typography>Unsere Gruppe hat ein{" "}
          ...
          vom Kontakt-Index ist nun, dass er fast ohne Verzögerung berechnet werden kann.</Typography>
          <Typography>
          Von einem erhöhten
