        ...
        <FaqAccordion
          ...
          content={
            <Box display="flex" flexDirection="column">
              <Typography>
                Auf der Karte stellen wir ein normales, mittleres und hohes Risiko dar.
              </Typography>
              <RiskHeading risk={3} />
              <Typography>
                Ein hohes Risiko leiten wir von der etablierten 7-Tages-Inzidenz des RKIs ab, wenn die Schwelle von 50 Neuinfektionen in den letzten 7 Tagen pro 100.000 Einwohner überschritten wurde.
              </Typography>
              <RiskHeading risk={2} />

              <Typography>
                Von einem mittleren Risiko gehen wir aus, wenn die 7-Tages-Inzidenz zwischen 20 und 50 Neuinfektionen in den letzten 7 Tagen pro 100.000 liegt oder unser Vorhersagemodell auf einen Anstieg der Neuinfektionen hindeutet. Eine Region mit mittlerem Risiko kann in Zukunft eine Region mit hohem Risiko werden.
              </Typography>
              <RiskHeading risk={1} />

              <Typography>
                Ein normales Risiko liegt vor, wenn die Zahl der Neuinfektionen gering ist und unser Vorhersagemodell keinen Anstieg vermuten lässt. Bitte beachte, dass das Virus derzeit überall in Deutschland zirkuliert und daher eine Ansteckung auch in einer Region mit einem normalen Risiko möglich ist.
              </Typography>
            </Box>
          }
        />
