      ...
      <section>
        ...
        <FaqAccordion title="Was macht die CovMap besonders?">
          <Typography style={{ width: "100%" }}>
            ...
            die Symptome spiegeln frühzeitig das Infektionsgeschehen wider und ermöglichen so eine zeitnahe Anpassung. Im Gegensatz dazu sind die Zahlen der Neuinfektionen, die vom Robert-Koch-Institut
        ...
        <FaqAccordion title="Was ist der Kontakt-Index?">
          <Typography style={{ width: "100%" }}>
            Der Kontakt-Index wurde von unserer Gruppe entwickelt und in einer wissenschaftlichen Arbeit (<a href="https://www.medrxiv.org/content/10.1101/2020.10.02.20188136v2">Preprint</a>) beschrieben.
            Grundlegend ist die Beobachtung, dass nicht jede Person die gleiche Zahl von Kontakten pro Tag hat, sondern
            es dabei sehr große Unterschiede gibt. Da Personen mit sehr vielen Kontakten („Superkontakter“)
            eine höhere Wahrscheinlichkeit haben, das Coronavirus weiterzugeben, spielt diese Beobachtung eine wichtige Rolle für
            die Ausbreitung des Coronavirus (siehe auch Freundschaftsparadox). Anders gesagt, ist nicht nur die reine Zahl an Kontakten für die
            Virusausbreitung entscheidend, sondern auch die Unterschiedlichkeit der Kontaktzahlen (Heterogenität). Der Kontakt-Index zeigt nun sowohl
            die Gesamtzahl der Kontakte als auch die Heterogenität an. Wir konnten zeigen, dass der
            Kontakt-Index sehr gut mit der Ausbreitung des Coronavirus in Deutschland korrelierte.
          </Typography>
        </FaqAccordion>
        ...
        <FaqAccordion title="Was kann ich konkret tun, um die Ausbreitung des Coronavirus zu verringern?">
          <Typography style={{ width: "100%" }}>
            Das Coronaviurs überträgt sich von Mensch zu Mensch, deswegen ist es wichtig, dass wir Kontakte reduzieren und uns zusätzlich an
            ...
            fast die wichtigsten Infektionsschutzmaßnahmen zusammen: Abstand halten, Hygiene beachten (Händewaschen, in die Ellenbeuge
