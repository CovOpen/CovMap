      ...
      <section>
        ...
        <FaqAccordion title="Warum hilft es Kontakte zu reduzieren?">
          <Typography style={{ width: "100%" }}>
            ...
            Weitere Informationen zum Coronavirus findest Du auf der <a href="https://www.rki.de/DE/Content/InfAZ/N/Neuartiges_Coronavirus/Steckbrief.html">Webpage des Robert-Koch-Instituts</a>.
        ...
        <FaqAccordion title="Was kann ich konkret tun, um die Ausbreitung des Coronavirus zu verringern?">
          <Typography style={{ width: "100%" }}>
            ...
            Infektionsschutzmaßnahmen halten und diese umzusetzen. Die <a href="https://www.infektionsschutz.de/coronavirus/alltag-in-zeiten-von-corona.html">AHA + L + A Formel</a> fast die wichtigsten Maßnahmen
            ...
            <a href="https://www.bundesregierung.de/breg-de/themen/corona-warn-app">Corona-Warn-App</a>, welche Nutzerinnen und Nutzer der APP über Kontakte zu infizierten Personen informiert.
        ...
        <FaqAccordion title="Was ist das Freundschaftsparadox?">
          <Typography style={{ width: "100%" }}>
            Der Kontakt-Index ist anschaulich mit dem sogenannten <a href="https://de.wikipedia.org/wiki/Freundschaftsparadox">Freundschaftsparadox</a> verbunden. Danach gilt für die meisten Menschen - z.B. in
