    ...
    <>
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          ...
          CovMap ist ein Gemeinschaftsprojekt der Charité, der NETCHECK GmbH und des Hasso Plattner Instituts, mit technischer Unterstützung von Port Blue Sky sowie vielen voluntären Unterstützern.
