...
export const WelcomeStepsModal: React.FC<{ subPage?: string }> = (props) => {
  ...
  return (
    <div>
      <Dialog style={{ height: "100%", overflow: "hidden" }} open={userPostalCode === null} fullScreen={fullScreen} onClose={onClose}>
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", overflow: "auto" }}>
